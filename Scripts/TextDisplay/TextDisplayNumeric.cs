...
/// </summary>
[Serializable]
public class TextDisplayNumeric : Jundroo.SimplePlanes.ModTools.Parts.PartModifier
{
    [SerializeField]
    ...
    [SerializeField]
    [DesignerPropertyToggleButton("D", "E", "F", "G", "N", "P", "R", "X", Header = "Formatting", Label = "Format Type", Order = 20)]
    private string _formatoption = "G";

    [SerializeField]
    [DesignerPropertyToggleButton(Label = "Lowercase Mode", Order = 30)]
    private bool _formatlower = false;

    [SerializeField]
    [DesignerPropertySlider(Label = "Precision Modifier", MaxValue = 10, MinValue = -1, NumberOfSteps = 12, Order = 40)]
    private int _formatprecision = 7;
    ...
    public override Jundroo.SimplePlanes.ModTools.Parts.PartModifierBehaviour Initialize(UnityEngine.GameObject partRootObject)
    {
        ...
        var behaviour = partRootObject.AddComponent<TextDisplayNumericBehaviour>();
        return behaviour;
    }
}